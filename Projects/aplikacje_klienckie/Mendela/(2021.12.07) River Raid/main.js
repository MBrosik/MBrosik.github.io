...
class Main {
    ...
    paintMap() {
        ...
        for (const key in _modules_LoadAllAudio__WEBPACK_IMPORTED_MODULE_17__.default.audios) {
            let audio = _modules_LoadAllAudio__WEBPACK_IMPORTED_MODULE_17__.default.audios[key];
            audio.pause();
            audio.currentTime = 0;
        }
        ...
        ([_modules_constants_Levels_level1__WEBPACK_IMPORTED_MODULE_0__.default, _modules_constants_Levels_level2__WEBPACK_IMPORTED_MODULE_15__.default]).forEach((level, ind, arr) => {
            ...
            let boostY = startPos.y - ind * _modules_constants_mapInfo__WEBPACK_IMPORTED_MODULE_5__.default.width / (imageBefore.width / imageBefore.height);
...
/* harmony import */ var _audio_flyNoise_wav__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../audio/flyNoise.wav */ "./src/audio/flyNoise.wav");
/* harmony import */ var _audio_flyStart_wav__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../audio/flyStart.wav */ "./src/audio/flyStart.wav");
/* harmony import */ var _audio_Health_wav__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../audio/Health.wav */ "./src/audio/Health.wav");
/* harmony import */ var _audio_strike_wav__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../audio/strike.wav */ "./src/audio/strike.wav");
/* harmony import */ var _audio_tankStrike_wav__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../audio/tankStrike.wav */ "./src/audio/tankStrike.wav");
/* harmony import */ var _audio_helicopterStrike_wav__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../audio/helicopterStrike.wav */ "./src/audio/helicopterStrike.wav");
...
class LoadAllAudio {
    static async getAudios() {
        ...
        LoadAllAudio.audios = {
            ...
            flyNoise: await (0,_utils_audioLoader__WEBPACK_IMPORTED_MODULE_0__.default)(_audio_flyNoise_wav__WEBPACK_IMPORTED_MODULE_3__.default),
            flyStart: await (0,_utils_audioLoader__WEBPACK_IMPORTED_MODULE_0__.default)(_audio_flyStart_wav__WEBPACK_IMPORTED_MODULE_4__.default),
            Health: await (0,_utils_audioLoader__WEBPACK_IMPORTED_MODULE_0__.default)(_audio_Health_wav__WEBPACK_IMPORTED_MODULE_5__.default),
            strike: await (0,_utils_audioLoader__WEBPACK_IMPORTED_MODULE_0__.default)(_audio_strike_wav__WEBPACK_IMPORTED_MODULE_6__.default),
            tankStrike: await (0,_utils_audioLoader__WEBPACK_IMPORTED_MODULE_0__.default)(_audio_tankStrike_wav__WEBPACK_IMPORTED_MODULE_7__.default),
            helicopterStrike: await (0,_utils_audioLoader__WEBPACK_IMPORTED_MODULE_0__.default)(_audio_helicopterStrike_wav__WEBPACK_IMPORTED_MODULE_8__.default),
        };
        //    document.body.onclick = async () => {
        //       resolve(true)
        //    }
...
class Player extends _utils_TwoJS_Image_Mesh__WEBPACK_IMPORTED_MODULE_2__.default {
    ...
    async playerMove() {
        ...
        if (_KeyboardManager__WEBPACK_IMPORTED_MODULE_9__.Keys.KeyW) {
            this.map_info.y -= 5;
            _Main__WEBPACK_IMPORTED_MODULE_0__.mainInstance.camera.y -= 5;
        }
        else if (_KeyboardManager__WEBPACK_IMPORTED_MODULE_9__.Keys.KeyS) {
            this.map_info.y -= 1;
            _Main__WEBPACK_IMPORTED_MODULE_0__.mainInstance.camera.y -= 1;
        }
        else {
            this.map_info.y -= 3;
            _Main__WEBPACK_IMPORTED_MODULE_0__.mainInstance.camera.y -= 3;
        }
        // --------------------
        // left right movement
        // --------------------
    ...
    checkLives() {
        for (const key in _LoadAllAudio__WEBPACK_IMPORTED_MODULE_10__.default.audios) {
            let audio = _LoadAllAudio__WEBPACK_IMPORTED_MODULE_10__.default.audios[key];
            audio.pause();
            audio.currentTime = 0;
        }
    ...
    async restartGame() {
        ...
        _GameConfig__WEBPACK_IMPORTED_MODULE_8__.default.moveBool = true;
...
class ScoreBoard {
    ...
    async fuelUsage() {
        ...
        if (Date.now() - this.loseFuelDateNow <= this.loseFuelTimeStamp)
            return;
        this.loseFuelDateNow = Date.now();
